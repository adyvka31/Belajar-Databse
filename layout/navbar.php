<div class="antialiased">
  <!-- Navbar -->
  <nav class="bg-white shadow-sm px-6 py-3 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center ">
      ...
      <div class="flex justify-center flex-1 lg:mr-32">
        <div
          ...
          <input
            class="w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 border-2 border-gray-200 rounded-xl rounded-md focus:outline-none focus:shadow-outline-purple form-input"
            type="text"
